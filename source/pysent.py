...
import sys, getopt, re, time, random
...
def main(argv):
	...
	print
	prompt ='Loaded slideshow with ' + str(totalSlides) + ' slides. Press Enter to start.'
	...
	while x < totalSlides:
		...
		#Transition to black and back
		transition = getFadeToBlackTransition()
...
def getFadeToBlackTransition():
	...
	for r in range(0,2*row):
		currentRow = ''
		chanceOfCharacter = getYofX(r,2*row)-.1
